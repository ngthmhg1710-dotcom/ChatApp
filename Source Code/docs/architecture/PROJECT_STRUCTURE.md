...
│   │   │   │
│   │   │   ├── personalStorage.route.js # /api/personal-storage/* : GET /, POST /, PUT /:id, DELETE /:id
│   │   │   │
...
│   │   │   │
│   │   │   ├── personalStorage.controller.js # CRUD cho ghi chú và file lưu trữ cá nhân
│   │   │   │
...
│   │   │   ├── Sidebar.jsx        # SIDEBAR (2253 dòng): IconBar, ChatPanel, GroupChatPanel, 
│   │   │   │                       # PersonalNotePanel (quản lý ghi chú cá nhân nội bộ),
...
│   │   │   │
│   │   │   │
│   │   │   ├── RecentPanel.jsx #Panel for recent: similar to ChatPanel
│   │   │   │
│   │   │   │
│   │   │   │
