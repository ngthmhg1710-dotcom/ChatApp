...
│   │   │   └── personalStorage.route.js # /api/personal-storage/* : lưu trữ cá nhân (ghi chú, file)
│   │   │
...
│   │   │   └── personalStorage.controller.js # Xử lý logic lưu trữ ghi chú cá nhân
│   │   │
...
│   │   │   ├── SearchUsers.jsx    # Search page: tìm kiếm người dùng hệ thống
│   │   │   ├── Profile.jsx        # User profile page: view/edit info, avatar upload
│   │   │   ├── DirectCallRoom.jsx # Page gọi điện 1-1 (WebRTC), hỗ trợ reload trang
...
│   │   │   ├── Sidebar.jsx        # SIDEBAR (2253 dòng): IconBar, ChatPanel, PersonalNotePanel (inline), SettingsPage modal
